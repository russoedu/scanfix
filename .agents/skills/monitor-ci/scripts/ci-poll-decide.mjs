...
const pollCount = Number(args[1]) || 0
...
const timeoutSeconds = Number(getArg('--timeout') || '0')
const newCipeTimeoutSeconds = Number(getArg('--new-cipe-timeout') || '0')
const envRerunCount = Number(getArg('--env-rerun-count') || '0')
const inputNoProgressCount = Number(getArg('--no-progress-count') || '0')
...
const messages = {
  ...
  self_healing_throttled: () =>
    'Self-healing throttled \u{2014} too many unapplied fixes.',
