...
export type { Change, CoordinateUnits, DiffOptions, ExpectedChange, ExpectedResult, PageDiff } from './change-detection'
...
export { annotateOverlay, connectedComponents, IDENTIFIED, mergeBoxes, NOT_IDENTIFIED, UNEXPECTED } from './change-detection'
export type { Annotation, Component, LabelOptions, MergedBox, Rgba } from './change-detection'
